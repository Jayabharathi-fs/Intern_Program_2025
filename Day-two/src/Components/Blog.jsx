...
const Blog = () => {
          ...
          <div className='lg:w-2/3'>
            ...
            <div className='block md:hidden relative min-h-screen overflow-visible'>
              ...
              <div className='sticky top-0 z-50'>
                <button aria-live='polite' className="w-full flex justify-between self-start items-center bg-white p-3 border border-black mt-5" onClick={() => setIsOpen(prev => !prev)}> {currentHeadingText || 'Table of Content'}
                  ...
                  {isOpen && (
                    <div className='flex flex-col mx-6 gap-4 p-3 w-auto h-auto bg-white border border-gray-500 mt-0 rounded-xl'>
                      <div>
                        <p className='font-bold text-2xl pt-2 pb-2'>Table of Content</p>
                      </div>
                      <div className='flex flex-col gap-4 px-3'>
                        <div className={`flex items-center justify-between bg-white rounded-3xl border border-gray-200 transition ${currentSectionId === 'para1' ? "bg-yellow-100 border border-yellow-400"
  : "bg-white border border-gray-200" }`} >
                        ...
                        <div className={`flex items-center justify-between bg-white rounded-3xl border border-gray-200 transition ${currentSectionId === 'para2' ? "bg-yellow-100 border border-yellow-400"
  : "bg-white border border-gray-200"}`}>
                          <a href='#para2' onClick={() => setIsOpen(false)} className='font-semibold text-lg leading-2xl p-3 w-full'>A Advocacy at Scale</a>
                        </div>
                        <div className={`flex items-center justify-between bg-white rounded-3xl border border-gray-200 transition ${currentSectionId === 'para3' ? "bg-yellow-100 border border-yellow-400"
  : "bg-white border border-gray-200" }`}>
                          <a href='#para3' onClick={() => setIsOpen(false)} className='font-semibold text-lg leading-2xl p-3 w-full'>The Power of Small Steps</a>
                        </div>
                        <div className={`flex items-center justify-between bg-white rounded-3xl border border-gray-200 transition ${currentSectionId === 'para4' ? "bg-yellow-100 border border-yellow-400"
  : "bg-white border border-gray-200" }`}>
                          <a href='#para4' onClick={() => setIsOpen(false)} className='font-semibold text-lg leading-2xl p-3 w-full'>A Life-Changing Experience</a>
                        </div>
                        <div className={`flex items-center justify-between bg-white rounded-3xl border border-gray-200 transition ${currentSectionId === 'para5' ? "bg-yellow-100 border border-yellow-400"
  : "bg-white border border-gray-200" }`}>
                          <a href='#para5' onClick={() => setIsOpen(false)} className='font-semibold text-lg leading-2xl p-3 w-full'>A Life-Changing Experience</a>
                        </div>
                        <div className={`flex items-center justify-between bg-white rounded-3xl border border-gray-200 transition ${currentSectionId === 'para6' ? "bg-yellow-100 border border-yellow-400"
  : "bg-white border border-gray-200" }`}>
          ...
          <div className='hidden md:block lg:block w-1/3'>
            ...
            <div className='sticky top-5 flex flex-col gap-4 p-5 w-full h-auto bg-white border border-gray-400 mt-14 rounded-xl'>
                <div>
                  <p className='font-bold text-2xl pt-4 pb-6'>Table of Content</p>
                </div>
                <div className='flex flex-col gap-4 px-5'>
                  <div className={`flex items-center justify-between border-b border-gray-200 transition ${currentSectionId === 'para1' ? "bg-yellow-100 border border-yellow-400 rounded-2xl"
  : "bg-white"}`}>
                    <a href='#para1' className='font-semibold text-lg leading-2xl p-3'>A Life-Changing Experience</a>
                    <ChevronRight className='text-gray-500' size={20} />
                  </div>
                  <div className={`flex items-center justify-between border-b border-gray-200 transition ${currentSectionId === 'para2' ? "bg-yellow-100 border border-yellow-400 rounded-2xl"
  : "bg-white"}`}>
                    <a href='#para2' className='font-semibold text-lg leading-2xl p-3'>A Advocacy at Scale</a>
                    <ChevronRight className='text-gray-500' size={20} />
                  </div>
                  <div className={`flex items-center justify-between border-b border-gray-200 transition ${currentSectionId === 'para3' ? "bg-yellow-100 border border-yellow-400 rounded-2xl"
  : "bg-white"}`}>
                    <a href='#para3' className='font-semibold text-lg leading-2xl p-3'>The Power of Small Steps</a>
                    <ChevronRight className='text-gray-500' size={20} />
                  </div>
                  <div className={`flex items-center justify-between border-b border-gray-200 transition ${currentSectionId === 'para4' ? "bg-yellow-100 border border-yellow-400 rounded-2xl"
  : "bg-white"}`}>
                    <a href='#para4' className='font-semibold text-lg leading-2xl p-3'>A Life-Changing Experience</a>
                    <ChevronRight className='text-gray-500' size={20} />
                  </div>
                  <div className={`flex items-center justify-between border-b border-gray-200 transition ${currentSectionId === 'para5' ? "bg-yellow-100 border border-yellow-400 rounded-2xl"
  : "bg-white"}`}>
                    <a href='#para5' className='font-semibold text-lg leading-2xl p-3'>A Life-Changing Experience</a>
                    <ChevronRight className='text-gray-500' size={20} />
                  </div>
                  <div className={`flex items-center justify-between border-b border-gray-200 transition ${currentSectionId === 'para6' ? "bg-yellow-100 border border-yellow-400 rounded-2xl"
  : "bg-white"}`}>
