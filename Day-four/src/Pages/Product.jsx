...
const Product = () => {
  ...
  return (
    <section className='min-h-svh xl:h-screen overflow-visible xl:overflow-hidden flex gap-x-6 mx-2 md:mx-4 xl:mx-8 p-4'>

        <div className='xl:block hidden w-1/5' role='region' aria-label='Vertical Image gallery slider'>
        {/* VERTICAL SLIDER LG */}
            <Swiper
        ...
        {/* <div className='flex flex-col w-full h-auto xl:p-0 xl:h-auto border border-gray-400 md:flex-col xl:flex-row xl:w-4/5'> */}
        <div className='flex flex-col w-full h-auto xl:p-0 xl:h-auto md:flex-col xl:flex-row xl:w-4/5'>

            <div className='relative w-auto xl:w-3/7 h-auto xl:h-full flex items-center justify-center' role='region' aria-label='Vertical Image gallery slider'>
                <button 
            ...
            <div className='block xl:hidden w-auto mt-3 px-8 h-auto'>
                {/* VERTICAL SLIDER SM */}
                <Swiper
            ...
            <div className='bg-white flex flex-col w-auto xl:w-4/7 gap-y-3 h-auto'>
                <div className='flex flex-col gap-y-5 px-8 pt-5 pb-6 xl:pb-0 xl:px-8 xl:pt-6 flex-1'>
                    ...
                    <div>
                        ...
                        <p className='font-lato leading-10 font-bold text-[40px]'>Skincare Glow Creme</p>
